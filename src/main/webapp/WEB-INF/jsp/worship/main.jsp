...
<div class="row">
        <div class="col-md-8 col-md-offset-2">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row">
			                <div class="col-md-12">
			                    <h3><b>교회는 회심한 사람들의 모임이다.</b></h3> <!-- Title 말씀제목 -->
    ...
    <div class="row" style="padding-top:20px">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="media">
                <a class="pull-left" href="#">
                    <img class="media-object img-rounded" src="<%=cp%>/images/worship/video2.jpg" width="160" height="120"/>
                </a>
                <div class="media-body">
            ...
            <div class="media">
                <a class="pull-left" href="#">
                    <img class="media-object img-rounded" src="<%=cp%>/images/worship/video3.jpg" width="160" height="120"/>
                </a>
                <div class="media-body">
            ...
            <div class="media">
                <a class="pull-left" href="#">
                    <img class="media-object img-rounded" src="<%=cp%>/images/worship/video4.jpg" width="160" height="120"/>
                </a>
                <div class="media-body">
