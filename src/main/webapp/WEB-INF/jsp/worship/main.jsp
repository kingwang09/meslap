...
<div class="worship-content">
	...
	<div class="worship-body-right" style="padding-top:25px">
		...
		<div style="padding-top:25px">
			<div class="h4"><b>교회는 회심한 사람들의 모임이다.</b></div> <!-- Title 말씀제목 -->
			<div class="h5"><b>데살로니가전서 1장 3절 - 10절</b></div> <!-- sub 말씀구절 -->
			<small>2014.07.31</small>     <!-- 날짜 -->
		</div>
		<div style="padding-top:25px">
		...
		<div style="padding-top:25px">
             <a href="#"><img class="hoverImages" imgName="top_bt_audio" src="<%=cp%>/images/main/top_bt_audio.jpg"/></a>
             <a href="#"><img class="hoverImages" imgName="top_bt_ebook" src="<%=cp%>/images/main/top_bt_ebook.jpg"/></a>
